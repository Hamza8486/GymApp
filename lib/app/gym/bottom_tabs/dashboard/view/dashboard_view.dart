...
import 'package:gym_app/app/gym/bottom_tabs/dashboard/components/gym_detail.dart';
                                ...
                                Padding(
                                  ...
                                  child: gymWidget(
                                    ...
                                    onTap2: (){
                                      ...
                                      onTap: (){
                                      homeController.updateGymId(homeController.gymList[index].id.toString());
                                      homeController.getVideoData(id:homeController.gymList[index].id.toString() );
                                      Get.to(GymDetail(data:homeController.gymList[index] ,),
                                    ...
                                    time1: DateFormat.jm().format(DateFormat("hh:mm").parse(homeController.gymList[index].endTime.toString())),
                                    time:DateFormat.jm().format(DateFormat("hh:mm").parse(homeController.gymList[index].startTime.toString())),
