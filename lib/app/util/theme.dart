...
class AppColor {
  static const primaryColor = Color(0xff265D64);
  static const secondary = Color(0xff235459);
  static const secondary1 = Color(0xffF2DC6C);
  ...
  static Color get primaryColor1 => const Color(0xff265D64);
  static Color get primaryColor2 => const Color(0xff265D64);
...
void showLoadingIndicator1({required BuildContext context}) {
  showDialog(
    barrierDismissible: false,
    useRootNavigator: false,
    context: context,
